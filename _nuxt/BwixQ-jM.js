...
`)}const tb={[Mf]:"Linear",[Sf]:"Reinhard",[Tf]:"Cineon",[Af]:"ACESFilmic",[wf]:"AgX",[Rf]:"Neutral",[Ef]:"Custom"};function eb(s,t){const e=tb[t];return e===void 0?(Tt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Xo=new P;function nb(){qt.getLuminanceCoefficients(Xo);const s=Xo.x.toFixed(4),t=Xo.y.toFixed(4),e=Xo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ib(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(zr).join(`
`)}function sb(s){const t=[];for(const e in s){const n=s[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function rb(s,t){const e={},n=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(t,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:s.getAttribLocation(t,o),locationSize:a}}return e}function zr(s){return s!==""}function xd(s,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function vd(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const ob=/^[ \t]*#include +<([\w\d./]+)>/gm;function Zl(s){return s.replace(ob,cb)}const ab=new Map;function cb(s,t){let e=Vt[t];if(e===void 0){const n=ab.get(t);if(n!==void 0)e=Vt[n],Tt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Zl(e)}const lb=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function yd(s){return s.replace(lb,ub)}function ub(s,t,e,n){let i="";for(let r=parseInt(t);r<parseInt(e);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function bd(s){let t=`precision ${s.precision} float;
...
#define LOW_PRECISION`),t}const hb={[ha]:"SHADOWMAP_TYPE_PCF",[Or]:"SHADOWMAP_TYPE_VSM"};function db(s){return hb[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const fb={[rs]:"ENVMAP_TYPE_CUBE",[Js]:"ENVMAP_TYPE_CUBE",[Oa]:"ENVMAP_TYPE_CUBE_UV"};function pb(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":fb[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const mb={[Js]:"ENVMAP_MODE_REFRACTION"};function gb(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":mb[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const _b={[pu]:"ENVMAP_BLENDING_MULTIPLY",[Jm]:"ENVMAP_BLENDING_MIX",[Qm]:"ENVMAP_BLENDING_ADD"};function xb(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":_b[s.combine]||"ENVMAP_BLENDING_NONE"}function vb(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function yb(s,t,e,n){const i=s.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=db(e),l=pb(e),u=gb(e),h=xb(e),d=vb(e),f=ib(e),g=sb(r),_=i.createProgram();let m,p,v=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const y=v+m+o,x=v+p+a,b=md(i,i.VERTEX_SHADER,y),T=md(i,i.FRAGMENT_SHADER,x);i.attachShader(_,b),i.attachShader(_,T),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function E(R){if(s.debug.checkShaderErrors){const I=i.getProgramInfoLog(_)||"",D=i.getShaderInfoLog(b)||"",U=i.getShaderInfoLog(T)||"",z=I.trim(),V=D.trim(),W=U.trim();let q=!0,it=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,b,T);else{const et=_d(i,b,"vertex"),st=_d(i,T,"fragment");Pt("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+et+`
`+st)}else z!==""?Tt("WebGLProgram: Program Info Log:",z):(V===""||W==="")&&(it=!1);it&&(R.diagnostics={runnable:q,programLog:z,vertexShader:{log:V,prefix:m},fragmentShader:{log:W,prefix:p}})}i.deleteShader(b),i.deleteShader(T),C=new xa(i,_),M=rb(i,_)}let C;this.getUniforms=function(){return C===void 0&&E(this),C};let M;this.getAttributes=function(){return M===void 0&&E(this),M};let S=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return S===!1&&(S=i.getProgramParameter(_,jy)),S},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=Ky++,this.cacheKey=t,this.usedTimes=1,this.program=_,this.vertexShader=b,this.fragmentShader=T,this}let bb=0;class Mb{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const e=t.vertexShader,n=t.fragmentShader,i=this._getShaderStage(e),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(t);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(t){const e=this.materialCache.get(t);for(const n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const e=this.materialCache;let n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){const e=this.shaderCache;let n=e.get(t);return n===void 0&&(n=new Sb(t),e.set(t,n)),n}}class Sb{constructor(t){this.id=bb++,this.code=t,this.usedTimes=0}}function Tb(s,t,e,n,i,r,o){const a=new wu,c=new Mb,l=new Set,u=[],h=new Map,d=i.logarithmicDepthBuffer;let f=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(M){return l.add(M),M===0?"uv":`uv${M}`}function m(M,S,R,I,D){const U=I.fog,z=D.geometry,V=M.isMeshStandardMaterial?I.environment:null,W=(M.isMeshStandardMaterial?e:t).get(M.envMap||V),q=W&&W.mapping===Oa?W.image.height:null,it=g[M.type];M.precision!==null&&(f=i.getMaxPrecision(M.precision),f!==M.precision&&Tt("WebGLProgram.getParameters:",M.precision,"not supported, using",f,"instead."));const et=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,st=et!==void 0?et.length:0;let It=0;z.morphAttributes.position!==void 0&&(It=1),z.morphAttributes.normal!==void 0&&(It=2),z.morphAttributes.color!==void 0&&(It=3);let Lt,Jt,Xt,j;if(it){const ne=Yn[it];Lt=ne.vertexShader,Jt=ne.fragmentShader}else Lt=M.vertexShader,Jt=M.fragmentShader,c.update(M),Xt=c.getVertexShaderID(M),j=c.getFragmentShaderID(M);const J=s.getRenderTarget(),ft=s.state.buffers.depth.getReversed(),Nt=D.isInstancedMesh===!0,gt=D.isBatchedMesh===!0,Ht=!!M.map,Te=!!M.matcap,jt=!!W,ee=!!M.aoMap,ae=!!M.lightMap,kt=!!M.bumpMap,Ie=!!M.normalMap,N=!!M.displacementMap,Le=!!M.emissiveMap,Qt=!!M.metalnessMap,he=!!M.roughnessMap,yt=M.anisotropy>0,L=M.clearcoat>0,A=M.dispersion>0,O=M.iridescence>0,$=M.sheen>0,Z=M.transmission>0,Y=yt&&!!M.anisotropyMap,Mt=L&&!!M.clearcoatMap,ot=L&&!!M.clearcoatNormalMap,vt=L&&!!M.clearcoatRoughnessMap,Ut=O&&!!M.iridescenceMap,tt=O&&!!M.iridescenceThicknessMap,ct=$&&!!M.sheenColorMap,xt=$&&!!M.sheenRoughnessMap,bt=!!M.specularMap,at=!!M.specularColorMap,Gt=!!M.specularIntensityMap,F=Z&&!!M.transmissionMap,dt=Z&&!!M.thicknessMap,nt=!!M.gradientMap,pt=!!M.alphaMap,Q=M.alphaTest>0,K=!!M.alphaHash,rt=!!M.extensions;let Ot=jn;M.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(Ot=s.toneMapping);const de={shaderID:it,shaderType:M.type,shaderName:M.name,vertexShader:Lt,fragmentShader:Jt,defines:M.defines,customVertexShaderID:Xt,customFragmentShaderID:j,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:f,batching:gt,batchingColor:gt&&D._colorsTexture!==null,instancing:Nt,instancingColor:Nt&&D.instanceColor!==null,instancingMorph:Nt&&D.morphTexture!==null,outputColorSpace:J===null?s.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:$e,alphaToCoverage:!!M.alphaToCoverage,map:Ht,matcap:Te,envMap:jt,envMapMode:jt&&W.mapping,envMapCubeUVHeight:q,aoMap:ee,lightMap:ae,bumpMap:kt,normalMap:Ie,displacementMap:N,emissiveMap:Le,normalMapObjectSpace:Ie&&M.normalMapType===ag,normalMapTangentSpace:Ie&&M.normalMapType===Mu,metalnessMap:Qt,roughnessMap:he,anisotropy:yt,anisotropyMap:Y,clearcoat:L,clearcoatMap:Mt,clearcoatNormalMap:ot,clearcoatRoughnessMap:vt,dispersion:A,iridescence:O,iridescenceMap:Ut,iridescenceThicknessMap:tt,sheen:$,sheenColorMap:ct,sheenRoughnessMap:xt,specularMap:bt,specularColorMap:at,specularIntensityMap:Gt,transmission:Z,transmissionMap:F,thicknessMap:dt,gradientMap:nt,opaque:M.transparent===!1&&M.blending===Ws&&M.alphaToCoverage===!1,alphaMap:pt,alphaTest:Q,alphaHash:K,combine:M.combine,mapUv:Ht&&_(M.map.channel),aoMapUv:ee&&_(M.aoMap.channel),lightMapUv:ae&&_(M.lightMap.channel),bumpMapUv:kt&&_(M.bumpMap.channel),normalMapUv:Ie&&_(M.normalMap.channel),displacementMapUv:N&&_(M.displacementMap.channel),emissiveMapUv:Le&&_(M.emissiveMap.channel),metalnessMapUv:Qt&&_(M.metalnessMap.channel),roughnessMapUv:he&&_(M.roughnessMap.channel),anisotropyMapUv:Y&&_(M.anisotropyMap.channel),clearcoatMapUv:Mt&&_(M.clearcoatMap.channel),clearcoatNormalMapUv:ot&&_(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:vt&&_(M.clearcoatRoughnessMap.channel),iridescenceMapUv:Ut&&_(M.iridescenceMap.channel),iridescenceThicknessMapUv:tt&&_(M.iridescenceThicknessMap.channel),sheenColorMapUv:ct&&_(M.sheenColorMap.channel),sheenRoughnessMapUv:xt&&_(M.sheenRoughnessMap.channel),specularMapUv:bt&&_(M.specularMap.channel),specularColorMapUv:at&&_(M.specularColorMap.channel),specularIntensityMapUv:Gt&&_(M.specularIntensityMap.channel),transmissionMapUv:F&&_(M.transmissionMap.channel),thicknessMapUv:dt&&_(M.thicknessMap.channel),alphaMapUv:pt&&_(M.alphaMap.channel),vertexTangents:!!z.attributes.tangent&&(Ie||yt),vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,pointsUvs:D.isPoints===!0&&!!z.attributes.uv&&(Ht||pt),fog:!!U,useFog:M.fog===!0,fogExp2:!!U&&U.isFogExp2,flatShading:M.flatShading===!0&&M.wireframe===!1,sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:ft,skinning:D.isSkinnedMesh===!0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:st,morphTextureStride:It,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:M.dithering,shadowMapEnabled:s.shadowMap.enabled&&R.length>0,shadowMapType:s.shadowMap.type,toneMapping:Ot,decodeVideoTexture:Ht&&M.map.isVideoTexture===!0&&qt.getTransfer(M.map.colorSpace)===se,decodeVideoTextureEmissive:Le&&M.emissiveMap.isVideoTexture===!0&&qt.getTransfer(M.emissiveMap.colorSpace)===se,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===Un,flipSided:M.side===on,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionClipCullDistance:rt&&M.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(rt&&M.extensions.multiDraw===!0||gt)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:M.customProgramCacheKey()};return de.vertexUv1s=l.has(1),de.vertexUv2s=l.has(2),de.vertexUv3s=l.has(3),l.clear(),de}function p(M){const S=[];if(M.shaderID?S.push(M.shaderID):(S.push(M.customVertexShaderID),S.push(M.customFragmentShaderID)),M.defines!==void 0)for(const R in M.defines)S.push(R),S.push(M.defines[R]);return M.isRawShaderMaterial===!1&&(v(S,M),y(S,M),S.push(s.outputColorSpace)),S.push(M.customProgramCacheKey),S.join()}function v(M,S){M.push(S.precision),M.push(S.outputColorSpace),M.push(S.envMapMode),M.push(S.envMapCubeUVHeight),M.push(S.mapUv),M.push(S.alphaMapUv),M.push(S.lightMapUv),M.push(S.aoMapUv),M.push(S.bumpMapUv),M.push(S.normalMapUv),M.push(S.displacementMapUv),M.push(S.emissiveMapUv),M.push(S.metalnessMapUv),M.push(S.roughnessMapUv),M.push(S.anisotropyMapUv),M.push(S.clearcoatMapUv),M.push(S.clearcoatNormalMapUv),M.push(S.clearcoatRoughnessMapUv),M.push(S.iridescenceMapUv),M.push(S.iridescenceThicknessMapUv),M.push(S.sheenColorMapUv),M.push(S.sheenRoughnessMapUv),M.push(S.specularMapUv),M.push(S.specularColorMapUv),M.push(S.specularIntensityMapUv),M.push(S.transmissionMapUv),M.push(S.thicknessMapUv),M.push(S.combine),M.push(S.fogExp2),M.push(S.sizeAttenuation),M.push(S.morphTargetsCount),M.push(S.morphAttributeCount),M.push(S.numDirLights),M.push(S.numPointLights),M.push(S.numSpotLights),M.push(S.numSpotLightMaps),M.push(S.numHemiLights),M.push(S.numRectAreaLights),M.push(S.numDirLightShadows),M.push(S.numPointLightShadows),M.push(S.numSpotLightShadows),M.push(S.numSpotLightShadowsWithMaps),M.push(S.numLightProbes),M.push(S.shadowMapType),M.push(S.toneMapping),M.push(S.numClippingPlanes),M.push(S.numClipIntersection),M.push(S.depthPacking)}function y(M,S){a.disableAll(),S.instancing&&a.enable(0),S.instancingColor&&a.enable(1),S.instancingMorph&&a.enable(2),S.matcap&&a.enable(3),S.envMap&&a.enable(4),S.normalMapObjectSpace&&a.enable(5),S.normalMapTangentSpace&&a.enable(6),S.clearcoat&&a.enable(7),S.iridescence&&a.enable(8),S.alphaTest&&a.enable(9),S.vertexColors&&a.enable(10),S.vertexAlphas&&a.enable(11),S.vertexUv1s&&a.enable(12),S.vertexUv2s&&a.enable(13),S.vertexUv3s&&a.enable(14),S.vertexTangents&&a.enable(15),S.anisotropy&&a.enable(16),S.alphaHash&&a.enable(17),S.batching&&a.enable(18),S.dispersion&&a.enable(19),S.batchingColor&&a.enable(20),S.gradientMap&&a.enable(21),M.push(a.mask),a.disableAll(),S.fog&&a.enable(0),S.useFog&&a.enable(1),S.flatShading&&a.enable(2),S.logarithmicDepthBuffer&&a.enable(3),S.reversedDepthBuffer&&a.enable(4),S.skinning&&a.enable(5),S.morphTargets&&a.enable(6),S.morphNormals&&a.enable(7),S.morphColors&&a.enable(8),S.premultipliedAlpha&&a.enable(9),S.shadowMapEnabled&&a.enable(10),S.doubleSided&&a.enable(11),S.flipSided&&a.enable(12),S.useDepthPacking&&a.enable(13),S.dithering&&a.enable(14),S.transmission&&a.enable(15),S.sheen&&a.enable(16),S.opaque&&a.enable(17),S.pointsUvs&&a.enable(18),S.decodeVideoTexture&&a.enable(19),S.decodeVideoTextureEmissive&&a.enable(20),S.alphaToCoverage&&a.enable(21),M.push(a.mask)}function x(M){const S=g[M.type];let R;if(S){const I=Yn[S];R=Zg.clone(I.uniforms)}else R=M.uniforms;return R}function b(M,S){let R=h.get(S);return R!==void 0?++R.usedTimes:(R=new yb(s,S,M,r),u.push(R),h.set(S,R)),R}function T(M){if(--M.usedTimes===0){const S=u.indexOf(M);u[S]=u[u.length-1],u.pop(),h.delete(M.cacheKey),M.destroy()}}function E(M){c.remove(M)}function C(){c.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:x,acquireProgram:b,releaseProgram:T,releaseShaderCache:E,programs:u,dispose:C}}function Ab(){let s=new WeakMap;function t(o){return s.has(o)}function e(o){let a=s.get(o);return a===void 0&&(a={},s.set(o,a)),a}function n(o){s.delete(o)}function i(o,a,c){s.get(o)[a]=c}function r(){s=new WeakMap}return{has:t,get:e,remove:n,update:i,dispose:r}}function Eb(s,t){return s.groupOrder!==t.groupOrder?s.groupOrder-t.groupOrder:s.renderOrder!==t.renderOrder?s.renderOrder-t.renderOrder:s.material.id!==t.material.id?s.material.id-t.material.id:s.z!==t.z?s.z-t.z:s.id-t.id}function Md(s,t){return s.groupOrder!==t.groupOrder?s.groupOrder-t.groupOrder:s.renderOrder!==t.renderOrder?s.renderOrder-t.renderOrder:s.z!==t.z?t.z-s.z:s.id-t.id}function Sd(){const s=[];let t=0;const e=[],n=[],i=[];function r(){t=0,e.length=0,n.length=0,i.length=0}function o(h,d,f,g,_,m){let p=s[t];return p===void 0?(p={id:h.id,object:h,geometry:d,material:f,groupOrder:g,renderOrder:h.renderOrder,z:_,group:m},s[t]=p):(p.id=h.id,p.object=h,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=h.renderOrder,p.z=_,p.group=m),t++,p}function a(h,d,f,g,_,m){const p=o(h,d,f,g,_,m);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):e.push(p)}function c(h,d,f,g,_,m){const p=o(h,d,f,g,_,m);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):e.unshift(p)}function l(h,d){e.length>1&&e.sort(h||Eb),n.length>1&&n.sort(d||Md),i.length>1&&i.sort(d||Md)}function u(){for(let h=t,d=s.length;h<d;h++){const f=s[h];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:e,transmissive:n,transparent:i,init:r,push:a,unshift:c,finish:u,sort:l}}function wb(){let s=new WeakMap;function t(n,i){const r=s.get(n);let o;return r===void 0?(o=new Sd,s.set(n,[o])):i>=r.length?(o=new Sd,r.push(o)):o=r[i],o}function e(){s=new WeakMap}return{get:t,dispose:e}}function Rb(){const s={};return{get:function(t){if(s[t.id]!==void 0)return s[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new P,color:new Ct};break;case"SpotLight":e={position:new P,direction:new P,color:new Ct,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new P,color:new Ct,distance:0,decay:0};break;case"HemisphereLight":e={direction:new P,skyColor:new Ct,groundColor:new Ct};break;case"RectAreaLight":e={color:new Ct,position:new P,halfWidth:new P,halfHeight:new P};break}return s[t.id]=e,e}}}function Cb(){const s={};return{get:function(t){if(s[t.id]!==void 0)return s[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Rt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Rt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Rt,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[t.id]=e,e}}}let Pb=0;function Ib(s,t){return(t.castShadow?2:0)-(s.castShadow?2:0)+(t.map?1:0)-(s.map?1:0)}function Lb(s){const t=new Rb,e=Cb(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new P);const i=new P,r=new At,o=new At;function a(l){let u=0,h=0,d=0;for(let M=0;M<9;M++)n.probe[M].set(0,0,0);let f=0,g=0,_=0,m=0,p=0,v=0,y=0,x=0,b=0,T=0,E=0;l.sort(Ib);for(let M=0,S=l.length;M<S;M++){const R=l[M],I=R.color,D=R.intensity,U=R.distance;let z=null;if(R.shadow&&R.shadow.map&&(R.shadow.map.texture.format===tr?z=R.shadow.map.texture:z=R.shadow.map.depthTexture||R.shadow.map.texture),R.isAmbientLight)u+=I.r*D,h+=I.g*D,d+=I.b*D;else if(R.isLightProbe){for(let V=0;V<9;V++)n.probe[V].addScaledVector(R.sh.coefficients[V],D);E++}else if(R.isDirectionalLight){const V=t.get(R);if(V.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){const W=R.shadow,q=e.get(R);q.shadowIntensity=W.intensity,q.shadowBias=W.bias,q.shadowNormalBias=W.normalBias,q.shadowRadius=W.radius,q.shadowMapSize=W.mapSize,n.directionalShadow[f]=q,n.directionalShadowMap[f]=z,n.directionalShadowMatrix[f]=R.shadow.matrix,v++}n.directional[f]=V,f++}else if(R.isSpotLight){const V=t.get(R);V.position.setFromMatrixPosition(R.matrixWorld),V.color.copy(I).multiplyScalar(D),V.distance=U,V.coneCos=Math.cos(R.angle),V.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),V.decay=R.decay,n.spot[_]=V;const W=R.shadow;if(R.map&&(n.spotLightMap[b]=R.map,b++,W.updateMatrices(R),R.castShadow&&T++),n.spotLightMatrix[_]=W.matrix,R.castShadow){const q=e.get(R);q.shadowIntensity=W.intensity,q.shadowBias=W.bias,q.shadowNormalBias=W.normalBias,q.shadowRadius=W.radius,q.shadowMapSize=W.mapSize,n.spotShadow[_]=q,n.spotShadowMap[_]=z,x++}_++}else if(R.isRectAreaLight){const V=t.get(R);V.color.copy(I).multiplyScalar(D),V.halfWidth.set(R.width*.5,0,0),V.halfHeight.set(0,R.height*.5,0),n.rectArea[m]=V,m++}else if(R.isPointLight){const V=t.get(R);if(V.color.copy(R.color).multiplyScalar(R.intensity),V.distance=R.distance,V.decay=R.decay,R.castShadow){const W=R.shadow,q=e.get(R);q.shadowIntensity=W.intensity,q.shadowBias=W.bias,q.shadowNormalBias=W.normalBias,q.shadowRadius=W.radius,q.shadowMapSize=W.mapSize,q.shadowCameraNear=W.camera.near,q.shadowCameraFar=W.camera.far,n.pointShadow[g]=q,n.pointShadowMap[g]=z,n.pointShadowMatrix[g]=R.shadow.matrix,y++}n.point[g]=V,g++}else if(R.isHemisphereLight){const V=t.get(R);V.skyColor.copy(R.color).multiplyScalar(D),V.groundColor.copy(R.groundColor).multiplyScalar(D),n.hemi[p]=V,p++}}m>0&&(s.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ut.LTC_FLOAT_1,n.rectAreaLTC2=ut.LTC_FLOAT_2):(n.rectAreaLTC1=ut.LTC_HALF_1,n.rectAreaLTC2=ut.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=d;const C=n.hash;(C.directionalLength!==f||C.pointLength!==g||C.spotLength!==_||C.rectAreaLength!==m||C.hemiLength!==p||C.numDirectionalShadows!==v||C.numPointShadows!==y||C.numSpotShadows!==x||C.numSpotMaps!==b||C.numLightProbes!==E)&&(n.directional.length=f,n.spot.length=_,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=v,n.directionalShadowMap.length=v,n.pointShadow.length=y,n.pointShadowMap.length=y,n.spotShadow.length=x,n.spotShadowMap.length=x,n.directionalShadowMatrix.length=v,n.pointShadowMatrix.length=y,n.spotLightMatrix.length=x+b-T,n.spotLightMap.length=b,n.numSpotLightShadowsWithMaps=T,n.numLightProbes=E,C.directionalLength=f,C.pointLength=g,C.spotLength=_,C.rectAreaLength=m,C.hemiLength=p,C.numDirectionalShadows=v,C.numPointShadows=y,C.numSpotShadows=x,C.numSpotMaps=b,C.numLightProbes=E,n.version=Pb++)}function c(l,u){let h=0,d=0,f=0,g=0,_=0;const m=u.matrixWorldInverse;for(let p=0,v=l.length;p<v;p++){const y=l[p];if(y.isDirectionalLight){const x=n.directional[h];x.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(m),h++}else if(y.isSpotLight){const x=n.spot[f];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(m),x.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(m),f++}else if(y.isRectAreaLight){const x=n.rectArea[g];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(m),o.identity(),r.copy(y.matrixWorld),r.premultiply(m),o.extractRotation(r),x.halfWidth.set(y.width*.5,0,0),x.halfHeight.set(0,y.height*.5,0),x.halfWidth.applyMatrix4(o),x.halfHeight.applyMatrix4(o),g++}else if(y.isPointLight){const x=n.point[d];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(m),d++}else if(y.isHemisphereLight){const x=n.hemi[_];x.direction.setFromMatrixPosition(y.matrixWorld),x.direction.transformDirection(m),_++}}}return{setup:a,setupView:c,state:n}}function Td(s){const t=new Lb(s),e=[],n=[];function i(u){l.camera=u,e.length=0,n.length=0}function r(u){e.push(u)}function o(u){n.push(u)}function a(){t.setup(e)}function c(u){t.setupView(e,u)}const l={lightsArray:e,shadowsArray:n,camera:null,lights:t,transmissionRenderTarget:{}};return{init:i,state:l,setupLights:a,setupLightsView:c,pushLight:r,pushShadow:o}}function Db(s){let t=new WeakMap;function e(i,r=0){const o=t.get(i);let a;return o===void 0?(a=new Td(s),t.set(i,[a])):r>=o.length?(a=new Td(s),o.push(a)):a=o[r],a}function n(){t=new WeakMap}return{get:e,dispose:n}}const Ub=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,Fb=[new P(1,0,0),new P(-1,0,0),new P(0,1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1)],Ob=[new P(0,-1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1),new P(0,-1,0),new P(0,-1,0)],Ad=new At,Rr=new P,Oc=new P;function Bb(s,t,e){let n=new no;const i=new Rt,r=new Rt,o=new _e,a=new M_,c=new S_,l={},u=e.maxTextureSize,h={[Bn]:on,[on]:Bn,[Un]:Un},d=new Jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Rt},radius:{value:4}},vertexShader:Ub,fragmentShader:Nb}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new ue;g.setAttribute("position",new Pe(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new me(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ha;let p=this.type;this.render=function(T,E,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;T.type===Dm&&(Tt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),T.type=ha);const M=s.getRenderTarget(),S=s.getActiveCubeFace(),R=s.getActiveMipmapLevel(),I=s.state;I.setBlending(di),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const D=p!==this.type;D&&E.traverse(function(U){U.material&&(Array.isArray(U.material)?U.material.forEach(z=>z.needsUpdate=!0):U.material.needsUpdate=!0)});for(let U=0,z=T.length;U<z;U++){const V=T[U],W=V.shadow;if(W===void 0){Tt("WebGLShadowMap:",V,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;i.copy(W.mapSize);const q=W.getFrameExtents();if(i.multiply(q),r.copy(W.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(r.x=Math.floor(u/q.x),i.x=r.x*q.x,W.mapSize.x=r.x),i.y>u&&(r.y=Math.floor(u/q.y),i.y=r.y*q.y,W.mapSize.y=r.y)),W.map===null||D===!0){if(W.map!==null&&(W.map.depthTexture!==null&&(W.map.depthTexture.dispose(),W.map.depthTexture=null),W.map.dispose()),this.type===Or){if(V.isPointLight){Tt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}W.map=new Kn(i.x,i.y,{format:tr,type:pi,minFilter:Ve,magFilter:Ve,generateMipmaps:!1}),W.map.texture.name=V.name+".shadowMap",W.map.depthTexture=new Jr(i.x,i.y,fn),W.map.depthTexture.name=V.name+".shadowMapDepth",W.map.depthTexture.format=mi,W.map.depthTexture.compareFunction=null,W.map.depthTexture.minFilter=Ce,W.map.depthTexture.magFilter=Ce}else{V.isPointLight?(W.map=new Xf(i.x),W.map.depthTexture=new v_(i.x,zn)):(W.map=new Kn(i.x,i.y),W.map.depthTexture=new Jr(i.x,i.y,zn)),W.map.depthTexture.name=V.name+".shadowMap",W.map.depthTexture.format=mi;const et=s.state.buffers.depth.getReversed();this.type===ha?(W.map.depthTexture.compareFunction=et?Tu:Su,W.map.depthTexture.minFilter=Ve,W.map.depthTexture.magFilter=Ve):(W.map.depthTexture.compareFunction=null,W.map.depthTexture.minFilter=Ce,W.map.depthTexture.magFilter=Ce)}W.camera.updateProjectionMatrix()}const it=W.map.isWebGLCubeRenderTarget?6:1;for(let et=0;et<it;et++){if(W.map.isWebGLCubeRenderTarget)s.setRenderTarget(W.map,et),s.clear();else{et===0&&(s.setRenderTarget(W.map),s.clear());const st=W.getViewport(et);o.set(r.x*st.x,r.y*st.y,r.x*st.z,r.y*st.w),I.viewport(o)}if(V.isPointLight){const st=W.camera,It=W.matrix,Lt=V.distance||st.far;Lt!==st.far&&(st.far=Lt,st.updateProjectionMatrix()),Rr.setFromMatrixPosition(V.matrixWorld),st.position.copy(Rr),Oc.copy(st.position),Oc.add(Fb[et]),st.up.copy(Ob[et]),st.lookAt(Oc),st.updateMatrixWorld(),It.makeTranslation(-Rr.x,-Rr.y,-Rr.z),Ad.multiplyMatrices(st.projectionMatrix,st.matrixWorldInverse),W._frustum.setFromProjectionMatrix(Ad,st.coordinateSystem,st.reversedDepth)}else W.updateMatrices(V);n=W.getFrustum(),x(E,C,W.camera,V,this.type)}W.isPointLightShadow!==!0&&this.type===Or&&v(W,C),W.needsUpdate=!1}p=this.type,m.needsUpdate=!1,s.setRenderTarget(M,S,R)};function v(T,E){const C=t.update(_);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Kn(i.x,i.y,{format:tr,type:pi})),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,s.setRenderTarget(T.mapPass),s.clear(),s.renderBufferDirect(E,null,C,d,_,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,s.setRenderTarget(T.map),s.clear(),s.renderBufferDirect(E,null,C,f,_,null)}function y(T,E,C,M){let S=null;const R=C.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(R!==void 0)S=R;else if(S=C.isPointLight===!0?c:a,s.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0||E.alphaToCoverage===!0){const I=S.uuid,D=E.uuid;let U=l[I];U===void 0&&(U={},l[I]=U);let z=U[D];z===void 0&&(z=S.clone(),U[D]=z,E.addEventListener("dispose",b)),S=z}if(S.visible=E.visible,S.wireframe=E.wireframe,M===Or?S.side=E.shadowSide!==null?E.shadowSide:E.side:S.side=E.shadowSide!==null?E.shadowSide:h[E.side],S.alphaMap=E.alphaMap,S.alphaTest=E.alphaToCoverage===!0?.5:E.alphaTest,S.map=E.map,S.clipShadows=E.clipShadows,S.clippingPlanes=E.clippingPlanes,S.clipIntersection=E.clipIntersection,S.displacementMap=E.displacementMap,S.displacementScale=E.displacementScale,S.displacementBias=E.displacementBias,S.wireframeLinewidth=E.wireframeLinewidth,S.linewidth=E.linewidth,C.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const I=s.properties.get(S);I.light=C}return S}function x(T,E,C,M,S){if(T.visible===!1)return;if(T.layers.test(E.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&S===Or)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,T.matrixWorld);const D=t.update(T),U=T.material;if(Array.isArray(U)){const z=D.groups;for(let V=0,W=z.length;V<W;V++){const q=z[V],it=U[q.materialIndex];if(it&&it.visible){const et=y(T,it,M,S);T.onBeforeShadow(s,T,E,C,D,et,q),s.renderBufferDirect(C,null,D,et,T,q),T.onAfterShadow(s,T,E,C,D,et,q)}}}else if(U.visible){const z=y(T,U,M,S);T.onBeforeShadow(s,T,E,C,D,z,null),s.renderBufferDirect(C,null,D,z,T,null),T.onAfterShadow(s,T,E,C,D,z,null)}}const I=T.children;for(let D=0,U=I.length;D<U;D++)x(I[D],E,C,M,S)}function b(T){T.target.removeEventListener("dispose",b);for(const C in l){const M=l[C],S=T.target.uuid;S in M&&(M[S].dispose(),delete M[S])}}}const zb={[sl]:rl,[ol]:ll,[al]:ul,[Zs]:cl,[rl]:sl,[ll]:ol,[ul]:al,[cl]:Zs};function Vb(s,t){function e(){let F=!1;const dt=new _e;let nt=null;const pt=new _e(0,0,0,0);return{setMask:function(Q){nt!==Q&&!F&&(s.colorMask(Q,Q,Q,Q),nt=Q)},setLocked:function(Q){F=Q},setClear:function(Q,K,rt,Ot,de){de===!0&&(Q*=Ot,K*=Ot,rt*=Ot),dt.set(Q,K,rt,Ot),pt.equals(dt)===!1&&(s.clearColor(Q,K,rt,Ot),pt.copy(dt))},reset:function(){F=!1,nt=null,pt.set(-1,0,0,0)}}}function n(){let F=!1,dt=!1,nt=null,pt=null,Q=null;return{setReversed:function(K){if(dt!==K){const rt=t.get("EXT_clip_control");K?rt.clipControlEXT(rt.LOWER_LEFT_EXT,rt.ZERO_TO_ONE_EXT):rt.clipControlEXT(rt.LOWER_LEFT_EXT,rt.NEGATIVE_ONE_TO_ONE_EXT),dt=K;const Ot=Q;Q=null,this.setClear(Ot)}},getReversed:function(){return dt},setTest:function(K){K?J(s.DEPTH_TEST):ft(s.DEPTH_TEST)},setMask:function(K){nt!==K&&!F&&(s.depthMask(K),nt=K)},setFunc:function(K){if(dt&&(K=zb[K]),pt!==K){switch(K){case sl:s.depthFunc(s.NEVER);break;case rl:s.depthFunc(s.ALWAYS);break;case ol:s.depthFunc(s.LESS);break;case Zs:s.depthFunc(s.LEQUAL);break;case al:s.depthFunc(s.EQUAL);break;case cl:s.depthFunc(s.GEQUAL);break;case ll:s.depthFunc(s.GREATER);break;case ul:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}pt=K}},setLocked:function(K){F=K},setClear:function(K){Q!==K&&(dt&&(K=1-K),s.clearDepth(K),Q=K)},reset:function(){F=!1,nt=null,pt=null,Q=null,dt=!1}}}function i(){let F=!1,dt=null,nt=null,pt=null,Q=null,K=null,rt=null,Ot=null,de=null;return{setTest:function(ne){F||(ne?J(s.STENCIL_TEST):ft(s.STENCIL_TEST))},setMask:function(ne){dt!==ne&&!F&&(s.stencilMask(ne),dt=ne)},setFunc:function(ne,Gn,ti){(nt!==ne||pt!==Gn||Q!==ti)&&(s.stencilFunc(ne,Gn,ti),nt=ne,pt=Gn,Q=ti)},setOp:function(ne,Gn,ti){(K!==ne||rt!==Gn||Ot!==ti)&&(s.stencilOp(ne,Gn,ti),K=ne,rt=Gn,Ot=ti)},setLocked:function(ne){F=ne},setClear:function(ne){de!==ne&&(s.clearStencil(ne),de=ne)},reset:function(){F=!1,dt=null,nt=null,pt=null,Q=null,K=null,rt=null,Ot=null,de=null}}}const r=new e,o=new n,a=new i,c=new WeakMap,l=new WeakMap;let u={},h={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,v=null,y=null,x=null,b=null,T=null,E=new Ct(0,0,0),C=0,M=!1,S=null,R=null,I=null,D=null,U=null;const z=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,W=0;const q=s.getParameter(s.VERSION);q.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(q)[1]),V=W>=1):q.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),V=W>=2);let it=null,et={};const st=s.getParameter(s.SCISSOR_BOX),It=s.getParameter(s.VIEWPORT),Lt=new _e().fromArray(st),Jt=new _e().fromArray(It);function Xt(F,dt,nt,pt){const Q=new Uint8Array(4),K=s.createTexture();s.bindTexture(F,K),s.texParameteri(F,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(F,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let rt=0;rt<nt;rt++)F===s.TEXTURE_3D||F===s.TEXTURE_2D_ARRAY?s.texImage3D(dt,0,s.RGBA,1,1,pt,0,s.RGBA,s.UNSIGNED_BYTE,Q):s.texImage2D(dt+rt,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Q);return K}const j={};j[s.TEXTURE_2D]=Xt(s.TEXTURE_2D,s.TEXTURE_2D,1),j[s.TEXTURE_CUBE_MAP]=Xt(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[s.TEXTURE_2D_ARRAY]=Xt(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),j[s.TEXTURE_3D]=Xt(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),J(s.DEPTH_TEST),o.setFunc(Zs),kt(!1),Ie(rh),J(s.CULL_FACE),ee(di);function J(F){u[F]!==!0&&(s.enable(F),u[F]=!0)}function ft(F){u[F]!==!1&&(s.disable(F),u[F]=!1)}function Nt(F,dt){return h[F]!==dt?(s.bindFramebuffer(F,dt),h[F]=dt,F===s.DRAW_FRAMEBUFFER&&(h[s.FRAMEBUFFER]=dt),F===s.FRAMEBUFFER&&(h[s.DRAW_FRAMEBUFFER]=dt),!0):!1}function gt(F,dt){let nt=f,pt=!1;if(F){nt=d.get(dt),nt===void 0&&(nt=[],d.set(dt,nt));const Q=F.textures;if(nt.length!==Q.length||nt[0]!==s.COLOR_ATTACHMENT0){for(let K=0,rt=Q.length;K<rt;K++)nt[K]=s.COLOR_ATTACHMENT0+K;nt.length=Q.length,pt=!0}}else nt[0]!==s.BACK&&(nt[0]=s.BACK,pt=!0);pt&&s.drawBuffers(nt)}function Ht(F){return g!==F?(s.useProgram(F),g=F,!0):!1}const Te={[Qi]:s.FUNC_ADD,[Nm]:s.FUNC_SUBTRACT,[Fm]:s.FUNC_REVERSE_SUBTRACT};Te[Om]=s.MIN,Te[Bm]=s.MAX;const jt={[zm]:s.ZERO,[Vm]:s.ONE,[km]:s.SRC_COLOR,[nl]:s.SRC_ALPHA,[Ym]:s.SRC_ALPHA_SATURATE,[Xm]:s.DST_COLOR,[Hm]:s.DST_ALPHA,[Gm]:s.ONE_MINUS_SRC_COLOR,[il]:s.ONE_MINUS_SRC_ALPHA,[qm]:s.ONE_MINUS_DST_COLOR,[Wm]:s.ONE_MINUS_DST_ALPHA,[$m]:s.CONSTANT_COLOR,[jm]:s.ONE_MINUS_CONSTANT_COLOR,[Km]:s.CONSTANT_ALPHA,[Zm]:s.ONE_MINUS_CONSTANT_ALPHA};function ee(F,dt,nt,pt,Q,K,rt,Ot,de,ne){if(F===di){_===!0&&(ft(s.BLEND),_=!1);return}if(_===!1&&(J(s.BLEND),_=!0),F!==Um){if(F!==m||ne!==M){if((p!==Qi||x!==Qi)&&(s.blendEquation(s.FUNC_ADD),p=Qi,x=Qi),ne)switch(F){case Ws:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case oh:s.blendFunc(s.ONE,s.ONE);break;case ah:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case ch:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:Pt("WebGLState: Invalid blending: ",F);break}else switch(F){case Ws:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case oh:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case ah:Pt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ch:Pt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Pt("WebGLState: Invalid blending: ",F);break}v=null,y=null,b=null,T=null,E.set(0,0,0),C=0,m=F,M=ne}return}Q=Q||dt,K=K||nt,rt=rt||pt,(dt!==p||Q!==x)&&(s.blendEquationSeparate(Te[dt],Te[Q]),p=dt,x=Q),(nt!==v||pt!==y||K!==b||rt!==T)&&(s.blendFuncSeparate(jt[nt],jt[pt],jt[K],jt[rt]),v=nt,y=pt,b=K,T=rt),(Ot.equals(E)===!1||de!==C)&&(s.blendColor(Ot.r,Ot.g,Ot.b,de),E.copy(Ot),C=de),m=F,M=!1}function ae(F,dt){F.side===Un?ft(s.CULL_FACE):J(s.CULL_FACE);let nt=F.side===on;dt&&(nt=!nt),kt(nt),F.blending===Ws&&F.transparent===!1?ee(di):ee(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),o.setFunc(F.depthFunc),o.setTest(F.depthTest),o.setMask(F.depthWrite),r.setMask(F.colorWrite);const pt=F.stencilWrite;a.setTest(pt),pt&&(a.setMask(F.stencilWriteMask),a.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),a.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),Le(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?J(s.SAMPLE_ALPHA_TO_COVERAGE):ft(s.SAMPLE_ALPHA_TO_COVERAGE)}function kt(F){S!==F&&(F?s.frontFace(s.CW):s.frontFace(s.CCW),S=F)}function Ie(F){F!==Im?(J(s.CULL_FACE),F!==R&&(F===rh?s.cullFace(s.BACK):F===Lm?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):ft(s.CULL_FACE),R=F}function N(F){F!==I&&(V&&s.lineWidth(F),I=F)}function Le(F,dt,nt){F?(J(s.POLYGON_OFFSET_FILL),(D!==dt||U!==nt)&&(s.polygonOffset(dt,nt),D=dt,U=nt)):ft(s.POLYGON_OFFSET_FILL)}function Qt(F){F?J(s.SCISSOR_TEST):ft(s.SCISSOR_TEST)}function he(F){F===void 0&&(F=s.TEXTURE0+z-1),it!==F&&(s.activeTexture(F),it=F)}function yt(F,dt,nt){nt===void 0&&(it===null?nt=s.TEXTURE0+z-1:nt=it);let pt=et[nt];pt===void 0&&(pt={type:void 0,texture:void 0},et[nt]=pt),(pt.type!==F||pt.texture!==dt)&&(it!==nt&&(s.activeTexture(nt),it=nt),s.bindTexture(F,dt||j[F]),pt.type=F,pt.texture=dt)}function L(){const F=et[it];F!==void 0&&F.type!==void 0&&(s.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function A(){try{s.compressedTexImage2D(...arguments)}catch(F){Pt("WebGLState:",F)}}function O(){try{s.compressedTexImage3D(...arguments)}catch(F){Pt("WebGLState:",F)}}function $(){try{s.texSubImage2D(...arguments)}catch(F){Pt("WebGLState:",F)}}function Z(){try{s.texSubImage3D(...arguments)}catch(F){Pt("WebGLState:",F)}}function Y(){try{s.compressedTexSubImage2D(...arguments)}catch(F){Pt("WebGLState:",F)}}function Mt(){try{s.compressedTexSubImage3D(...arguments)}catch(F){Pt("WebGLState:",F)}}function ot(){try{s.texStorage2D(...arguments)}catch(F){Pt("WebGLState:",F)}}function vt(){try{s.texStorage3D(...arguments)}catch(F){Pt("WebGLState:",F)}}function Ut(){try{s.texImage2D(...arguments)}catch(F){Pt("WebGLState:",F)}}function tt(){try{s.texImage3D(...arguments)}catch(F){Pt("WebGLState:",F)}}function ct(F){Lt.equals(F)===!1&&(s.scissor(F.x,F.y,F.z,F.w),Lt.copy(F))}function xt(F){Jt.equals(F)===!1&&(s.viewport(F.x,F.y,F.z,F.w),Jt.copy(F))}function bt(F,dt){let nt=l.get(dt);nt===void 0&&(nt=new WeakMap,l.set(dt,nt));let pt=nt.get(F);pt===void 0&&(pt=s.getUniformBlockIndex(dt,F.name),nt.set(F,pt))}function at(F,dt){const pt=l.get(dt).get(F);c.get(dt)!==pt&&(s.uniformBlockBinding(dt,pt,F.__bindingPointIndex),c.set(dt,pt))}function Gt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),o.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),u={},it=null,et={},h={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,v=null,y=null,x=null,b=null,T=null,E=new Ct(0,0,0),C=0,M=!1,S=null,R=null,I=null,D=null,U=null,Lt.set(0,0,s.canvas.width,s.canvas.height),Jt.set(0,0,s.canvas.width,s.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:J,disable:ft,bindFramebuffer:Nt,drawBuffers:gt,useProgram:Ht,setBlending:ee,setMaterial:ae,setFlipSided:kt,setCullFace:Ie,setLineWidth:N,setPolygonOffset:Le,setScissorTest:Qt,activeTexture:he,bindTexture:yt,unbindTexture:L,compressedTexImage2D:A,compressedTexImage3D:O,texImage2D:Ut,texImage3D:tt,updateUBOMapping:bt,uniformBlockBinding:at,texStorage2D:ot,texStorage3D:vt,texSubImage2D:$,texSubImage3D:Z,compressedTexSubImage2D:Y,compressedTexSubImage3D:Mt,scissor:ct,viewport:xt,reset:Gt}}function kb(s,t,e,n,i,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Rt,u=new WeakMap;let h;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(L,A){return f?new OffscreenCanvas(L,A):Kr("canvas")}function _(L,A,O){let $=1;const Z=yt(L);if((Z.width>O||Z.height>O)&&($=O/Math.max(Z.width,Z.height)),$<1)if(typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&L instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&L instanceof ImageBitmap||typeof VideoFrame<"u"&&L instanceof VideoFrame){const Y=Math.floor($*Z.width),Mt=Math.floor($*Z.height);h===void 0&&(h=g(Y,Mt));const ot=A?g(Y,Mt):h;return ot.width=Y,ot.height=Mt,ot.getContext("2d").drawImage(L,0,0,Y,Mt),Tt("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+Y+"x"+Mt+")."),ot}else return"data"in L&&Tt("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),L;return L}function m(L){return L.generateMipmaps}function p(L){s.generateMipmap(L)}function v(L){return L.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:L.isWebGL3DRenderTarget?s.TEXTURE_3D:L.isWebGLArrayRenderTarget||L.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function y(L,A,O,$,Z=!1){if(L!==null){if(s[L]!==void 0)return s[L];Tt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+L+"'")}let Y=A;if(A===s.RED&&(O===s.FLOAT&&(Y=s.R32F),O===s.HALF_FLOAT&&(Y=s.R16F),O===s.UNSIGNED_BYTE&&(Y=s.R8)),A===s.RED_INTEGER&&(O===s.UNSIGNED_BYTE&&(Y=s.R8UI),O===s.UNSIGNED_SHORT&&(Y=s.R16UI),O===s.UNSIGNED_INT&&(Y=s.R32UI),O===s.BYTE&&(Y=s.R8I),O===s.SHORT&&(Y=s.R16I),O===s.INT&&(Y=s.R32I)),A===s.RG&&(O===s.FLOAT&&(Y=s.RG32F),O===s.HALF_FLOAT&&(Y=s.RG16F),O===s.UNSIGNED_BYTE&&(Y=s.RG8)),A===s.RG_INTEGER&&(O===s.UNSIGNED_BYTE&&(Y=s.RG8UI),O===s.UNSIGNED_SHORT&&(Y=s.RG16UI),O===s.UNSIGNED_INT&&(Y=s.RG32UI),O===s.BYTE&&(Y=s.RG8I),O===s.SHORT&&(Y=s.RG16I),O===s.INT&&(Y=s.RG32I)),A===s.RGB_INTEGER&&(O===s.UNSIGNED_BYTE&&(Y=s.RGB8UI),O===s.UNSIGNED_SHORT&&(Y=s.RGB16UI),O===s.UNSIGNED_INT&&(Y=s.RGB32UI),O===s.BYTE&&(Y=s.RGB8I),O===s.SHORT&&(Y=s.RGB16I),O===s.INT&&(Y=s.RGB32I)),A===s.RGBA_INTEGER&&(O===s.UNSIGNED_BYTE&&(Y=s.RGBA8UI),O===s.UNSIGNED_SHORT&&(Y=s.RGBA16UI),O===s.UNSIGNED_INT&&(Y=s.RGBA32UI),O===s.BYTE&&(Y=s.RGBA8I),O===s.SHORT&&(Y=s.RGBA16I),O===s.INT&&(Y=s.RGBA32I)),A===s.RGB&&(O===s.UNSIGNED_INT_5_9_9_9_REV&&(Y=s.RGB9_E5),O===s.UNSIGNED_INT_10F_11F_11F_REV&&(Y=s.R11F_G11F_B10F)),A===s.RGBA){const Mt=Z?wa:qt.getTransfer($);O===s.FLOAT&&(Y=s.RGBA32F),O===s.HALF_FLOAT&&(Y=s.RGBA16F),O===s.UNSIGNED_BYTE&&(Y=Mt===se?s.SRGB8_ALPHA8:s.RGBA8),O===s.UNSIGNED_SHORT_4_4_4_4&&(Y=s.RGBA4),O===s.UNSIGNED_SHORT_5_5_5_1&&(Y=s.RGB5_A1)}return(Y===s.R16F||Y===s.R32F||Y===s.RG16F||Y===s.RG32F||Y===s.RGBA16F||Y===s.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function x(L,A){let O;return L?A===null||A===zn||A===Yr?O=s.DEPTH24_STENCIL8:A===fn?O=s.DEPTH32F_STENCIL8:A===qr&&(O=s.DEPTH24_STENCIL8,Tt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):A===null||A===zn||A===Yr?O=s.DEPTH_COMPONENT24:A===fn?O=s.DEPTH_COMPONENT32F:A===qr&&(O=s.DEPTH_COMPONENT16),O}function b(L,A){return m(L)===!0||L.isFramebufferTexture&&L.minFilter!==Ce&&L.minFilter!==Ve?Math.log2(Math.max(A.width,A.height))+1:L.mipmaps!==void 0&&L.mipmaps.length>0?L.mipmaps.length:L.isCompressedTexture&&Array.isArray(L.image)?A.mipmaps.length:1}function T(L){const A=L.target;A.removeEventListener("dispose",T),C(A),A.isVideoTexture&&u.delete(A)}function E(L){const A=L.target;A.removeEventListener("dispose",E),S(A)}function C(L){const A=n.get(L);if(A.__webglInit===void 0)return;const O=L.source,$=d.get(O);if($){const Z=$[A.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&M(L),Object.keys($).length===0&&d.delete(O)}n.remove(L)}function M(L){const A=n.get(L);s.deleteTexture(A.__webglTexture);const O=L.source,$=d.get(O);delete $[A.__cacheKey],o.memory.textures--}function S(L){const A=n.get(L);if(L.depthTexture&&(L.depthTexture.dispose(),n.remove(L.depthTexture)),L.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(A.__webglFramebuffer[$]))for(let Z=0;Z<A.__webglFramebuffer[$].length;Z++)s.deleteFramebuffer(A.__webglFramebuffer[$][Z]);else s.deleteFramebuffer(A.__webglFramebuffer[$]);A.__webglDepthbuffer&&s.deleteRenderbuffer(A.__webglDepthbuffer[$])}else{if(Array.isArray(A.__webglFramebuffer))for(let $=0;$<A.__webglFramebuffer.length;$++)s.deleteFramebuffer(A.__webglFramebuffer[$]);else s.deleteFramebuffer(A.__webglFramebuffer);if(A.__webglDepthbuffer&&s.deleteRenderbuffer(A.__webglDepthbuffer),A.__webglMultisampledFramebuffer&&s.deleteFramebuffer(A.__webglMultisampledFramebuffer),A.__webglColorRenderbuffer)for(let $=0;$<A.__webglColorRenderbuffer.length;$++)A.__webglColorRenderbuffer[$]&&s.deleteRenderbuffer(A.__webglColorRenderbuffer[$]);A.__webglDepthRenderbuffer&&s.deleteRenderbuffer(A.__webglDepthRenderbuffer)}const O=L.textures;for(let $=0,Z=O.length;$<Z;$++){const Y=n.get(O[$]);Y.__webglTexture&&(s.deleteTexture(Y.__webglTexture),o.memory.textures--),n.remove(O[$])}n.remove(L)}let R=0;function I(){R=0}function D(){const L=R;return L>=i.maxTextures&&Tt("WebGLTextures: Trying to use "+L+" texture units while this GPU supports only "+i.maxTextures),R+=1,L}function U(L){const A=[];return A.push(L.wrapS),A.push(L.wrapT),A.push(L.wrapR||0),A.push(L.magFilter),A.push(L.minFilter),A.push(L.anisotropy),A.push(L.internalFormat),A.push(L.format),A.push(L.type),A.push(L.generateMipmaps),A.push(L.premultiplyAlpha),A.push(L.flipY),A.push(L.unpackAlignment),A.push(L.colorSpace),A.join()}function z(L,A){const O=n.get(L);if(L.isVideoTexture&&Qt(L),L.isRenderTargetTexture===!1&&L.isExternalTexture!==!0&&L.version>0&&O.__version!==L.version){const $=L.image;if($===null)Tt("WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)Tt("WebGLRenderer: Texture marked for update but image is incomplete");else{j(O,L,A);return}}else L.isExternalTexture&&(O.__webglTexture=L.sourceTexture?L.sourceTexture:null);e.bindTexture(s.TEXTURE_2D,O.__webglTexture,s.TEXTURE0+A)}function V(L,A){const O=n.get(L);if(L.isRenderTargetTexture===!1&&L.version>0&&O.__version!==L.version){j(O,L,A);return}else L.isExternalTexture&&(O.__webglTexture=L.sourceTexture?L.sourceTexture:null);e.bindTexture(s.TEXTURE_2D_ARRAY,O.__webglTexture,s.TEXTURE0+A)}function W(L,A){const O=n.get(L);if(L.isRenderTargetTexture===!1&&L.version>0&&O.__version!==L.version){j(O,L,A);return}e.bindTexture(s.TEXTURE_3D,O.__webglTexture,s.TEXTURE0+A)}function q(L,A){const O=n.get(L);if(L.isCubeDepthTexture!==!0&&L.version>0&&O.__version!==L.version){J(O,L,A);return}e.bindTexture(s.TEXTURE_CUBE_MAP,O.__webglTexture,s.TEXTURE0+A)}const it={[Qs]:s.REPEAT,[$n]:s.CLAMP_TO_EDGE,[Aa]:s.MIRRORED_REPEAT},et={[Ce]:s.NEAREST,[Pf]:s.NEAREST_MIPMAP_NEAREST,[Br]:s.NEAREST_MIPMAP_LINEAR,[Ve]:s.LINEAR,[da]:s.LINEAR_MIPMAP_NEAREST,[ui]:s.LINEAR_MIPMAP_LINEAR},st={[cg]:s.NEVER,[fg]:s.ALWAYS,[lg]:s.LESS,[Su]:s.LEQUAL,[ug]:s.EQUAL,[Tu]:s.GEQUAL,[hg]:s.GREATER,[dg]:s.NOTEQUAL};function It(L,A){if(A.type===fn&&t.has("OES_texture_float_linear")===!1&&(A.magFilter===Ve||A.magFilter===da||A.magFilter===Br||A.magFilter===ui||A.minFilter===Ve||A.minFilter===da||A.minFilter===Br||A.minFilter===ui)&&Tt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(L,s.TEXTURE_WRAP_S,it[A.wrapS]),s.texParameteri(L,s.TEXTURE_WRAP_T,it[A.wrapT]),(L===s.TEXTURE_3D||L===s.TEXTURE_2D_ARRAY)&&s.texParameteri(L,s.TEXTURE_WRAP_R,it[A.wrapR]),s.texParameteri(L,s.TEXTURE_MAG_FILTER,et[A.magFilter]),s.texParameteri(L,s.TEXTURE_MIN_FILTER,et[A.minFilter]),A.compareFunction&&(s.texParameteri(L,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(L,s.TEXTURE_COMPARE_FUNC,st[A.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(A.magFilter===Ce||A.minFilter!==Br&&A.minFilter!==ui||A.type===fn&&t.has("OES_texture_float_linear")===!1)return;if(A.anisotropy>1||n.get(A).__currentAnisotropy){const O=t.get("EXT_texture_filter_anisotropic");s.texParameterf(L,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,i.getMaxAnisotropy())),n.get(A).__currentAnisotropy=A.anisotropy}}}function Lt(L,A){let O=!1;L.__webglInit===void 0&&(L.__webglInit=!0,A.addEventListener("dispose",T));const $=A.source;let Z=d.get($);Z===void 0&&(Z={},d.set($,Z));const Y=U(A);if(Y!==L.__cacheKey){Z[Y]===void 0&&(Z[Y]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,O=!0),Z[Y].usedTimes++;const Mt=Z[L.__cacheKey];Mt!==void 0&&(Z[L.__cacheKey].usedTimes--,Mt.usedTimes===0&&M(A)),L.__cacheKey=Y,L.__webglTexture=Z[Y].texture}return O}function Jt(L,A,O){return Math.floor(Math.floor(L/O)/A)}function Xt(L,A,O,$){const Y=L.updateRanges;if(Y.length===0)e.texSubImage2D(s.TEXTURE_2D,0,0,0,A.width,A.height,O,$,A.data);else{Y.sort((tt,ct)=>tt.start-ct.start);let Mt=0;for(let tt=1;tt<Y.length;tt++){const ct=Y[Mt],xt=Y[tt],bt=ct.start+ct.count,at=Jt(xt.start,A.width,4),Gt=Jt(ct.start,A.width,4);xt.start<=bt+1&&at===Gt&&Jt(xt.start+xt.count-1,A.width,4)===at?ct.count=Math.max(ct.count,xt.start+xt.count-ct.start):(++Mt,Y[Mt]=xt)}Y.length=Mt+1;const ot=s.getParameter(s.UNPACK_ROW_LENGTH),vt=s.getParameter(s.UNPACK_SKIP_PIXELS),Ut=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,A.width);for(let tt=0,ct=Y.length;tt<ct;tt++){const xt=Y[tt],bt=Math.floor(xt.start/4),at=Math.ceil(xt.count/4),Gt=bt%A.width,F=Math.floor(bt/A.width),dt=at,nt=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,Gt),s.pixelStorei(s.UNPACK_SKIP_ROWS,F),e.texSubImage2D(s.TEXTURE_2D,0,Gt,F,dt,nt,O,$,A.data)}L.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,ot),s.pixelStorei(s.UNPACK_SKIP_PIXELS,vt),s.pixelStorei(s.UNPACK_SKIP_ROWS,Ut)}}function j(L,A,O){let $=s.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&($=s.TEXTURE_2D_ARRAY),A.isData3DTexture&&($=s.TEXTURE_3D);const Z=Lt(L,A),Y=A.source;e.bindTexture($,L.__webglTexture,s.TEXTURE0+O);const Mt=n.get(Y);if(Y.version!==Mt.__version||Z===!0){e.activeTexture(s.TEXTURE0+O);const ot=qt.getPrimaries(qt.workingColorSpace),vt=A.colorSpace===Ri?null:qt.getPrimaries(A.colorSpace),Ut=A.colorSpace===Ri||ot===vt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,A.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,A.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ut);let tt=_(A.image,!1,i.maxTextureSize);tt=he(A,tt);const ct=r.convert(A.format,A.colorSpace),xt=r.convert(A.type);let bt=y(A.internalFormat,ct,xt,A.colorSpace,A.isVideoTexture);It($,A);let at;const Gt=A.mipmaps,F=A.isVideoTexture!==!0,dt=Mt.__version===void 0||Z===!0,nt=Y.dataReady,pt=b(A,tt);if(A.isDepthTexture)bt=x(A.format===es,A.type),dt&&(F?e.texStorage2D(s.TEXTURE_2D,1,bt,tt.width,tt.height):e.texImage2D(s.TEXTURE_2D,0,bt,tt.width,tt.height,0,ct,xt,null));else if(A.isDataTexture)if(Gt.length>0){F&&dt&&e.texStorage2D(s.TEXTURE_2D,pt,bt,Gt[0].width,Gt[0].height);for(let Q=0,K=Gt.length;Q<K;Q++)at=Gt[Q],F?nt&&e.texSubImage2D(s.TEXTURE_2D,Q,0,0,at.width,at.height,ct,xt,at.data):e.texImage2D(s.TEXTURE_2D,Q,bt,at.width,at.height,0,ct,xt,at.data);A.generateMipmaps=!1}else F?(dt&&e.texStorage2D(s.TEXTURE_2D,pt,bt,tt.width,tt.height),nt&&Xt(A,tt,ct,xt)):e.texImage2D(s.TEXTURE_2D,0,bt,tt.width,tt.height,0,ct,xt,tt.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){F&&dt&&e.texStorage3D(s.TEXTURE_2D_ARRAY,pt,bt,Gt[0].width,Gt[0].height,tt.depth);for(let Q=0,K=Gt.length;Q<K;Q++)if(at=Gt[Q],A.format!==pn)if(ct!==null)if(F){if(nt)if(A.layerUpdates.size>0){const rt=nd(at.width,at.height,A.format,A.type);for(const Ot of A.layerUpdates){const de=at.data.subarray(Ot*rt/at.data.BYTES_PER_ELEMENT,(Ot+1)*rt/at.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,Ot,at.width,at.height,1,ct,de)}A.clearLayerUpdates()}else e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,at.width,at.height,tt.depth,ct,at.data)}else e.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Q,bt,at.width,at.height,tt.depth,0,at.data,0,0);else Tt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else F?nt&&e.texSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,at.width,at.height,tt.depth,ct,xt,at.data):e.texImage3D(s.TEXTURE_2D_ARRAY,Q,bt,at.width,at.height,tt.depth,0,ct,xt,at.data)}else{F&&dt&&e.texStorage2D(s.TEXTURE_2D,pt,bt,Gt[0].width,Gt[0].height);for(let Q=0,K=Gt.length;Q<K;Q++)at=Gt[Q],A.format!==pn?ct!==null?F?nt&&e.compressedTexSubImage2D(s.TEXTURE_2D,Q,0,0,at.width,at.height,ct,at.data):e.compressedTexImage2D(s.TEXTURE_2D,Q,bt,at.width,at.height,0,at.data):Tt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):F?nt&&e.texSubImage2D(s.TEXTURE_2D,Q,0,0,at.width,at.height,ct,xt,at.data):e.texImage2D(s.TEXTURE_2D,Q,bt,at.width,at.height,0,ct,xt,at.data)}else if(A.isDataArrayTexture)if(F){if(dt&&e.texStorage3D(s.TEXTURE_2D_ARRAY,pt,bt,tt.width,tt.height,tt.depth),nt)if(A.layerUpdates.size>0){const Q=nd(tt.width,tt.height,A.format,A.type);for(const K of A.layerUpdates){const rt=tt.data.subarray(K*Q/tt.data.BYTES_PER_ELEMENT,(K+1)*Q/tt.data.BYTES_PER_ELEMENT);e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,K,tt.width,tt.height,1,ct,xt,rt)}A.clearLayerUpdates()}else e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,ct,xt,tt.data)}else e.texImage3D(s.TEXTURE_2D_ARRAY,0,bt,tt.width,tt.height,tt.depth,0,ct,xt,tt.data);else if(A.isData3DTexture)F?(dt&&e.texStorage3D(s.TEXTURE_3D,pt,bt,tt.width,tt.height,tt.depth),nt&&e.texSubImage3D(s.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,ct,xt,tt.data)):e.texImage3D(s.TEXTURE_3D,0,bt,tt.width,tt.height,tt.depth,0,ct,xt,tt.data);else if(A.isFramebufferTexture){if(dt)if(F)e.texStorage2D(s.TEXTURE_2D,pt,bt,tt.width,tt.height);else{let Q=tt.width,K=tt.height;for(let rt=0;rt<pt;rt++)e.texImage2D(s.TEXTURE_2D,rt,bt,Q,K,0,ct,xt,null),Q>>=1,K>>=1}}else if(Gt.length>0){if(F&&dt){const Q=yt(Gt[0]);e.texStorage2D(s.TEXTURE_2D,pt,bt,Q.width,Q.height)}for(let Q=0,K=Gt.length;Q<K;Q++)at=Gt[Q],F?nt&&e.texSubImage2D(s.TEXTURE_2D,Q,0,0,ct,xt,at):e.texImage2D(s.TEXTURE_2D,Q,bt,ct,xt,at);A.generateMipmaps=!1}else if(F){if(dt){const Q=yt(tt);e.texStorage2D(s.TEXTURE_2D,pt,bt,Q.width,Q.height)}nt&&e.texSubImage2D(s.TEXTURE_2D,0,0,0,ct,xt,tt)}else e.texImage2D(s.TEXTURE_2D,0,bt,ct,xt,tt);m(A)&&p($),Mt.__version=Y.version,A.onUpdate&&A.onUpdate(A)}L.__version=A.version}function J(L,A,O){if(A.image.length!==6)return;const $=Lt(L,A),Z=A.source;e.bindTexture(s.TEXTURE_CUBE_MAP,L.__webglTexture,s.TEXTURE0+O);const Y=n.get(Z);if(Z.version!==Y.__version||$===!0){e.activeTexture(s.TEXTURE0+O);const Mt=qt.getPrimaries(qt.workingColorSpace),ot=A.colorSpace===Ri?null:qt.getPrimaries(A.colorSpace),vt=A.colorSpace===Ri||Mt===ot?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,A.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,A.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,vt);const Ut=A.isCompressedTexture||A.image[0].isCompressedTexture,tt=A.image[0]&&A.image[0].isDataTexture,ct=[];for(let K=0;K<6;K++)!Ut&&!tt?ct[K]=_(A.image[K],!0,i.maxCubemapSize):ct[K]=tt?A.image[K].image:A.image[K],ct[K]=he(A,ct[K]);const xt=ct[0],bt=r.convert(A.format,A.colorSpace),at=r.convert(A.type),Gt=y(A.internalFormat,bt,at,A.colorSpace),F=A.isVideoTexture!==!0,dt=Y.__version===void 0||$===!0,nt=Z.dataReady;let pt=b(A,xt);It(s.TEXTURE_CUBE_MAP,A);let Q;if(Ut){F&&dt&&e.texStorage2D(s.TEXTURE_CUBE_MAP,pt,Gt,xt.width,xt.height);for(let K=0;K<6;K++){Q=ct[K].mipmaps;for(let rt=0;rt<Q.length;rt++){const Ot=Q[rt];A.format!==pn?bt!==null?F?nt&&e.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,rt,0,0,Ot.width,Ot.height,bt,Ot.data):e.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,rt,Gt,Ot.width,Ot.height,0,Ot.data):Tt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):F?nt&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,rt,0,0,Ot.width,Ot.height,bt,at,Ot.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,rt,Gt,Ot.width,Ot.height,0,bt,at,Ot.data)}}}else{if(Q=A.mipmaps,F&&dt){Q.length>0&&pt++;const K=yt(ct[0]);e.texStorage2D(s.TEXTURE_CUBE_MAP,pt,Gt,K.width,K.height)}for(let K=0;K<6;K++)if(tt){F?nt&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ct[K].width,ct[K].height,bt,at,ct[K].data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Gt,ct[K].width,ct[K].height,0,bt,at,ct[K].data);for(let rt=0;rt<Q.length;rt++){const de=Q[rt].image[K].image;F?nt&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,rt+1,0,0,de.width,de.height,bt,at,de.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,rt+1,Gt,de.width,de.height,0,bt,at,de.data)}}else{F?nt&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,bt,at,ct[K]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Gt,bt,at,ct[K]);for(let rt=0;rt<Q.length;rt++){const Ot=Q[rt];F?nt&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,rt+1,0,0,bt,at,Ot.image[K]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+K,rt+1,Gt,bt,at,Ot.image[K])}}}m(A)&&p(s.TEXTURE_CUBE_MAP),Y.__version=Z.version,A.onUpdate&&A.onUpdate(A)}L.__version=A.version}function ft(L,A,O,$,Z,Y){const Mt=r.convert(O.format,O.colorSpace),ot=r.convert(O.type),vt=y(O.internalFormat,Mt,ot,O.colorSpace),Ut=n.get(A),tt=n.get(O);if(tt.__renderTarget=A,!Ut.__hasExternalTextures){const ct=Math.max(1,A.width>>Y),xt=Math.max(1,A.height>>Y);Z===s.TEXTURE_3D||Z===s.TEXTURE_2D_ARRAY?e.texImage3D(Z,Y,vt,ct,xt,A.depth,0,Mt,ot,null):e.texImage2D(Z,Y,vt,ct,xt,0,Mt,ot,null)}e.bindFramebuffer(s.FRAMEBUFFER,L),Le(A)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,$,Z,tt.__webglTexture,0,N(A)):(Z===s.TEXTURE_2D||Z>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,$,Z,tt.__webglTexture,Y),e.bindFramebuffer(s.FRAMEBUFFER,null)}function Nt(L,A,O){if(s.bindRenderbuffer(s.RENDERBUFFER,L),A.depthBuffer){const $=A.depthTexture,Z=$&&$.isDepthTexture?$.type:null,Y=x(A.stencilBuffer,Z),Mt=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;Le(A)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,N(A),Y,A.width,A.height):O?s.renderbufferStorageMultisample(s.RENDERBUFFER,N(A),Y,A.width,A.height):s.renderbufferStorage(s.RENDERBUFFER,Y,A.width,A.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Mt,s.RENDERBUFFER,L)}else{const $=A.textures;for(let Z=0;Z<$.length;Z++){const Y=$[Z],Mt=r.convert(Y.format,Y.colorSpace),ot=r.convert(Y.type),vt=y(Y.internalFormat,Mt,ot,Y.colorSpace);Le(A)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,N(A),vt,A.width,A.height):O?s.renderbufferStorageMultisample(s.RENDERBUFFER,N(A),vt,A.width,A.height):s.renderbufferStorage(s.RENDERBUFFER,vt,A.width,A.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function gt(L,A,O){const $=A.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(s.FRAMEBUFFER,L),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(A.depthTexture);if(Z.__renderTarget=A,(!Z.__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),$){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,A.depthTexture.addEventListener("dispose",T)),Z.__webglTexture===void 0){Z.__webglTexture=s.createTexture(),e.bindTexture(s.TEXTURE_CUBE_MAP,Z.__webglTexture),It(s.TEXTURE_CUBE_MAP,A.depthTexture);const Ut=r.convert(A.depthTexture.format),tt=r.convert(A.depthTexture.type);let ct;A.depthTexture.format===mi?ct=s.DEPTH_COMPONENT24:A.depthTexture.format===es&&(ct=s.DEPTH24_STENCIL8);for(let xt=0;xt<6;xt++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,ct,A.width,A.height,0,Ut,tt,null)}}else z(A.depthTexture,0);const Y=Z.__webglTexture,Mt=N(A),ot=$?s.TEXTURE_CUBE_MAP_POSITIVE_X+O:s.TEXTURE_2D,vt=A.depthTexture.format===es?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(A.depthTexture.format===mi)Le(A)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,vt,ot,Y,0,Mt):s.framebufferTexture2D(s.FRAMEBUFFER,vt,ot,Y,0);else if(A.depthTexture.format===es)Le(A)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,vt,ot,Y,0,Mt):s.framebufferTexture2D(s.FRAMEBUFFER,vt,ot,Y,0);else throw new Error("Unknown depthTexture format")}function Ht(L){const A=n.get(L),O=L.isWebGLCubeRenderTarget===!0;if(A.__boundDepthTexture!==L.depthTexture){const $=L.depthTexture;if(A.__depthDisposeCallback&&A.__depthDisposeCallback(),$){const Z=()=>{delete A.__boundDepthTexture,delete A.__depthDisposeCallback,$.removeEventListener("dispose",Z)};$.addEventListener("dispose",Z),A.__depthDisposeCallback=Z}A.__boundDepthTexture=$}if(L.depthTexture&&!A.__autoAllocateDepthBuffer)if(O)for(let $=0;$<6;$++)gt(A.__webglFramebuffer[$],L,$);else{const $=L.texture.mipmaps;$&&$.length>0?gt(A.__webglFramebuffer[0],L,0):gt(A.__webglFramebuffer,L,0)}else if(O){A.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(e.bindFramebuffer(s.FRAMEBUFFER,A.__webglFramebuffer[$]),A.__webglDepthbuffer[$]===void 0)A.__webglDepthbuffer[$]=s.createRenderbuffer(),Nt(A.__webglDepthbuffer[$],L,!1);else{const Z=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Y=A.__webglDepthbuffer[$];s.bindRenderbuffer(s.RENDERBUFFER,Y),s.framebufferRenderbuffer(s.FRAMEBUFFER,Z,s.RENDERBUFFER,Y)}}else{const $=L.texture.mipmaps;if($&&$.length>0?e.bindFramebuffer(s.FRAMEBUFFER,A.__webglFramebuffer[0]):e.bindFramebuffer(s.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer===void 0)A.__webglDepthbuffer=s.createRenderbuffer(),Nt(A.__webglDepthbuffer,L,!1);else{const Z=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Y=A.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,Y),s.framebufferRenderbuffer(s.FRAMEBUFFER,Z,s.RENDERBUFFER,Y)}}e.bindFramebuffer(s.FRAMEBUFFER,null)}function Te(L,A,O){const $=n.get(L);A!==void 0&&ft($.__webglFramebuffer,L,L.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),O!==void 0&&Ht(L)}function jt(L){const A=L.texture,O=n.get(L),$=n.get(A);L.addEventListener("dispose",E);const Z=L.textures,Y=L.isWebGLCubeRenderTarget===!0,Mt=Z.length>1;if(Mt||($.__webglTexture===void 0&&($.__webglTexture=s.createTexture()),$.__version=A.version,o.memory.textures++),Y){O.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(A.mipmaps&&A.mipmaps.length>0){O.__webglFramebuffer[ot]=[];for(let vt=0;vt<A.mipmaps.length;vt++)O.__webglFramebuffer[ot][vt]=s.createFramebuffer()}else O.__webglFramebuffer[ot]=s.createFramebuffer()}else{if(A.mipmaps&&A.mipmaps.length>0){O.__webglFramebuffer=[];for(let ot=0;ot<A.mipmaps.length;ot++)O.__webglFramebuffer[ot]=s.createFramebuffer()}else O.__webglFramebuffer=s.createFramebuffer();if(Mt)for(let ot=0,vt=Z.length;ot<vt;ot++){const Ut=n.get(Z[ot]);Ut.__webglTexture===void 0&&(Ut.__webglTexture=s.createTexture(),o.memory.textures++)}if(L.samples>0&&Le(L)===!1){O.__webglMultisampledFramebuffer=s.createFramebuffer(),O.__webglColorRenderbuffer=[],e.bindFramebuffer(s.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let ot=0;ot<Z.length;ot++){const vt=Z[ot];O.__webglColorRenderbuffer[ot]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,O.__webglColorRenderbuffer[ot]);const Ut=r.convert(vt.format,vt.colorSpace),tt=r.convert(vt.type),ct=y(vt.internalFormat,Ut,tt,vt.colorSpace,L.isXRRenderTarget===!0),xt=N(L);s.renderbufferStorageMultisample(s.RENDERBUFFER,xt,ct,L.width,L.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ot,s.RENDERBUFFER,O.__webglColorRenderbuffer[ot])}s.bindRenderbuffer(s.RENDERBUFFER,null),L.depthBuffer&&(O.__webglDepthRenderbuffer=s.createRenderbuffer(),Nt(O.__webglDepthRenderbuffer,L,!0)),e.bindFramebuffer(s.FRAMEBUFFER,null)}}if(Y){e.bindTexture(s.TEXTURE_CUBE_MAP,$.__webglTexture),It(s.TEXTURE_CUBE_MAP,A);for(let ot=0;ot<6;ot++)if(A.mipmaps&&A.mipmaps.length>0)for(let vt=0;vt<A.mipmaps.length;vt++)ft(O.__webglFramebuffer[ot][vt],L,A,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ot,vt);else ft(O.__webglFramebuffer[ot],L,A,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);m(A)&&p(s.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Mt){for(let ot=0,vt=Z.length;ot<vt;ot++){const Ut=Z[ot],tt=n.get(Ut);let ct=s.TEXTURE_2D;(L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(ct=L.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),e.bindTexture(ct,tt.__webglTexture),It(ct,Ut),ft(O.__webglFramebuffer,L,Ut,s.COLOR_ATTACHMENT0+ot,ct,0),m(Ut)&&p(ct)}e.unbindTexture()}else{let ot=s.TEXTURE_2D;if((L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(ot=L.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),e.bindTexture(ot,$.__webglTexture),It(ot,A),A.mipmaps&&A.mipmaps.length>0)for(let vt=0;vt<A.mipmaps.length;vt++)ft(O.__webglFramebuffer[vt],L,A,s.COLOR_ATTACHMENT0,ot,vt);else ft(O.__webglFramebuffer,L,A,s.COLOR_ATTACHMENT0,ot,0);m(A)&&p(ot),e.unbindTexture()}L.depthBuffer&&Ht(L)}function ee(L){const A=L.textures;for(let O=0,$=A.length;O<$;O++){const Z=A[O];if(m(Z)){const Y=v(L),Mt=n.get(Z).__webglTexture;e.bindTexture(Y,Mt),p(Y),e.unbindTexture()}}}const ae=[],kt=[];function Ie(L){if(L.samples>0){if(Le(L)===!1){const A=L.textures,O=L.width,$=L.height;let Z=s.COLOR_BUFFER_BIT;const Y=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Mt=n.get(L),ot=A.length>1;if(ot)for(let Ut=0;Ut<A.length;Ut++)e.bindFramebuffer(s.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ut,s.RENDERBUFFER,null),e.bindFramebuffer(s.FRAMEBUFFER,Mt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ut,s.TEXTURE_2D,null,0);e.bindFramebuffer(s.READ_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer);const vt=L.texture.mipmaps;vt&&vt.length>0?e.bindFramebuffer(s.DRAW_FRAMEBUFFER,Mt.__webglFramebuffer[0]):e.bindFramebuffer(s.DRAW_FRAMEBUFFER,Mt.__webglFramebuffer);for(let Ut=0;Ut<A.length;Ut++){if(L.resolveDepthBuffer&&(L.depthBuffer&&(Z|=s.DEPTH_BUFFER_BIT),L.stencilBuffer&&L.resolveStencilBuffer&&(Z|=s.STENCIL_BUFFER_BIT)),ot){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Mt.__webglColorRenderbuffer[Ut]);const tt=n.get(A[Ut]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,tt,0)}s.blitFramebuffer(0,0,O,$,0,0,O,$,Z,s.NEAREST),c===!0&&(ae.length=0,kt.length=0,ae.push(s.COLOR_ATTACHMENT0+Ut),L.depthBuffer&&L.resolveDepthBuffer===!1&&(ae.push(Y),kt.push(Y),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,kt)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,ae))}if(e.bindFramebuffer(s.READ_FRAMEBUFFER,null),e.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ot)for(let Ut=0;Ut<A.length;Ut++){e.bindFramebuffer(s.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ut,s.RENDERBUFFER,Mt.__webglColorRenderbuffer[Ut]);const tt=n.get(A[Ut]).__webglTexture;e.bindFramebuffer(s.FRAMEBUFFER,Mt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ut,s.TEXTURE_2D,tt,0)}e.bindFramebuffer(s.DRAW_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer)}else if(L.depthBuffer&&L.resolveDepthBuffer===!1&&c){const A=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[A])}}}function N(L){return Math.min(i.maxSamples,L.samples)}function Le(L){const A=n.get(L);return L.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function Qt(L){const A=o.render.frame;u.get(L)!==A&&(u.set(L,A),L.update())}function he(L,A){const O=L.colorSpace,$=L.format,Z=L.type;return L.isCompressedTexture===!0||L.isVideoTexture===!0||O!==$e&&O!==Ri&&(qt.getTransfer(O)===se?($!==pn||Z!==vn)&&Tt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Pt("WebGLTextures: Unsupported texture color space:",O)),A}function yt(L){return typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement?(l.width=L.naturalWidth||L.width,l.height=L.naturalHeight||L.height):typeof VideoFrame<"u"&&L instanceof VideoFrame?(l.width=L.displayWidth,l.height=L.displayHeight):(l.width=L.width,l.height=L.height),l}this.allocateTextureUnit=D,this.resetTextureUnits=I,this.setTexture2D=z,this.setTexture2DArray=V,this.setTexture3D=W,this.setTextureCube=q,this.rebindTextures=Te,this.setupRenderTarget=jt,this.updateRenderTargetMipmap=ee,this.updateMultisampleRenderTarget=Ie,this.setupDepthRenderbuffer=Ht,this.setupFrameBufferTexture=ft,this.useMultisampledRTT=Le,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Gb(s,t){function e(n,i=Ri){let r;const o=qt.getTransfer(i);if(n===vn)return s.UNSIGNED_BYTE;if(n===gu)return s.UNSIGNED_SHORT_4_4_4_4;if(n===_u)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Df)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Uf)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===If)return s.BYTE;if(n===Lf)return s.SHORT;if(n===qr)return s.UNSIGNED_SHORT;if(n===mu)return s.INT;if(n===zn)return s.UNSIGNED_INT;if(n===fn)return s.FLOAT;if(n===pi)return s.HALF_FLOAT;if(n===Nf)return s.ALPHA;if(n===Ff)return s.RGB;if(n===pn)return s.RGBA;if(n===mi)return s.DEPTH_COMPONENT;if(n===es)return s.DEPTH_STENCIL;if(n===xu)return s.RED;if(n===Ba)return s.RED_INTEGER;if(n===tr)return s.RG;if(n===vu)return s.RG_INTEGER;if(n===yu)return s.RGBA_INTEGER;if(n===fa||n===pa||n===ma||n===ga)if(o===se)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===fa)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===pa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ma)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ga)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===fa)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===pa)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ma)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ga)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===fl||n===pl||n===ml||n===gl)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===fl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===pl)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ml)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===gl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===_l||n===xl||n===vl||n===yl||n===bl||n===Ml||n===Sl)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===_l||n===xl)return o===se?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===vl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===yl)return r.COMPRESSED_R11_EAC;if(n===bl)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Ml)return r.COMPRESSED_RG11_EAC;if(n===Sl)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Tl||n===Al||n===El||n===wl||n===Rl||n===Cl||n===Pl||n===Il||n===Ll||n===Dl||n===Ul||n===Nl||n===Fl||n===Ol)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Tl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Al)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===El)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===wl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Rl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Cl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Pl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Il)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ll)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Dl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ul)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Nl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Fl)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ol)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Bl||n===zl||n===Vl)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Bl)return o===se?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===zl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Vl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===kl||n===Gl||n===Hl||n===Wl)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===kl)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Gl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Hl)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Wl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Yr?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:e}}const Hb=`
void main() {
