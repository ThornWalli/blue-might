...
#define LOW_PRECISION`),t}function jx(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Rl?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===mu?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===_n&&(t="SHADOWMAP_TYPE_VSM"),t}function $x(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Pi:case Di:t="ENVMAP_TYPE_CUBE";break;case _s:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Kx(r){let t="ENVMAP_MODE_REFLECTION";return r.envMap&&r.envMapMode===Di&&(t="ENVMAP_MODE_REFRACTION"),t}function Zx(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case go:t="ENVMAP_BLENDING_MULTIPLY";break;case Uu:t="ENVMAP_BLENDING_MIX";break;case Nu:t="ENVMAP_BLENDING_ADD";break}return t}function Jx(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Qx(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=jx(e),c=$x(e),h=Kx(e),u=Zx(e),d=Jx(e),p=Vx(e),x=kx(s),g=i.createProgram();let m,f,T=e.glslVersion?"#version "+e.glslVersion+`
