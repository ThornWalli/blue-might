...
import baseGlb from './assets/civilian_1.glb?url';

export type Options = FigureUnitOptions;

export interface RawUnitDescription_Civilian_1<
  O extends UnitOptions = Options
> extends RawUnitDescription<UnitConstructorOptions<O>> {
  key: 'civilian_1';
}

export default class Civilian_1<
...
> extends FigureUnit<Modules, ModuleList, Options> {
  static override KEY = 'civilian_1';
