...
import baseGlb from './assets/scientist_1.glb?url';

export type Options = FigureUnitOptions;

export interface RawUnitDescription_Scientist_1<
  O extends UnitOptions = Options
> extends RawUnitDescription<UnitConstructorOptions<O>> {
  key: 'scientist_1';
}

export default class Scientist_1<
...
> extends FigureUnit<Modules, ModuleList, Options> {
  static override KEY = 'scientist_1';
